...
namespace GodotRx {
  ...
  public static class SignalExtensions {
    public static IObservable<Unit> OnScriptChanged(this GodotObject obj) => obj.ObserveSignal("script_changed");
    public static IObservable<Unit> OnChanged(this Godot.Resource obj) => obj.ObserveSignal("changed");
    ...
    public static IObservable<Unit> OnVersionChanged(this Godot.UndoRedo obj) => obj.ObserveSignal("version_changed");
    public static IObservable<Unit> OnRenamed(this Godot.Node obj) => obj.ObserveSignal("renamed");
    public static IObservable<Unit> OnReady(this Godot.Node obj) => obj.ObserveSignal("ready");
    public static IObservable<Unit> OnTreeEntered(this Godot.Node obj) => obj.ObserveSignal("tree_entered");
    public static IObservable<Unit> OnTreeExiting(this Godot.Node obj) => obj.ObserveSignal("tree_exiting");
    public static IObservable<Unit> OnTreeExited(this Godot.Node obj) => obj.ObserveSignal("tree_exited");
    public static IObservable<Unit> OnSizeChanged(this Godot.Viewport obj) => obj.ObserveSignal("size_changed");
    ...
    public static IObservable<Unit> OnMouseExited(this Godot.Control obj) => obj.ObserveSignal("mouse_exited");

    public static IObservable<Godot.InputEvent> OnGuiInput(this Godot.Control obj) =>
      obj.ObserveSignal<Godot.InputEvent>("gui_input");

    public static IObservable<Unit> OnModalClosed(this Godot.Control obj) => obj.ObserveSignal("modal_closed");
    public static IObservable<Unit> OnFocusEntered(this Godot.Control obj) => obj.ObserveSignal("focus_entered");
    public static IObservable<Unit> OnResized(this Godot.Control obj) => obj.ObserveSignal("resized");

    public static IObservable<Unit> OnMinimumSizeChanged(this Godot.Control obj) =>
      obj.ObserveSignal("minimum_size_changed");

    public static IObservable<Unit> OnMouseEntered(this Godot.Control obj) => obj.ObserveSignal("mouse_entered");

    public static IObservable<Unit> OnSizeFlagsChanged(this Godot.Control obj) =>
      obj.ObserveSignal("size_flags_changed");

    public static IObservable<Unit> OnFocusExited(this Godot.Control obj) => obj.ObserveSignal("focus_exited");

    public static IObservable<(int Result, int ResponseCode, string[] Headers, byte[] Body)>
      OnRequestCompleted(this Godot.HttpRequest obj) =>
      obj.ObserveSignal<int, int, string[], byte[]>("request_completed");

    public static IObservable<Unit> OnTimeout(this Godot.Timer obj) => obj.ObserveSignal("timeout");

    public static IObservable<Unit> OnItemRectChanged(this Godot.CanvasItem obj) =>
      obj.ObserveSignal("item_rect_changed");

    public static IObservable<Unit> OnDraw(this Godot.CanvasItem obj) => obj.ObserveSignal("draw");

    public static IObservable<Unit> OnVisibilityChanged(this Godot.CanvasItem obj) =>
      obj.ObserveSignal("visibility_changed");

    public static IObservable<Unit> OnHide(this Godot.CanvasItem obj) => obj.ObserveSignal("hide");
    public static IObservable<Unit> OnButtonDown(this Godot.BaseButton obj) => obj.ObserveSignal("button_down");
    public static IObservable<bool> OnToggled(this Godot.BaseButton obj) => obj.ObserveSignal<bool>("toggled");
    public static IObservable<Unit> OnPressed(this Godot.BaseButton obj) => obj.ObserveSignal("pressed");
    public static IObservable<Unit> OnButtonUp(this Godot.BaseButton obj) => obj.ObserveSignal("button_up");
    public static IObservable<float> OnValueChanged(this Godot.Range obj) => obj.ObserveSignal<float>("value_changed");
    public static IObservable<Unit> OnChanged(this Godot.Range obj) => obj.ObserveSignal("changed");
    ...
    public static IObservable<Unit> OnConfirmed(this Godot.AcceptDialog obj) => obj.ObserveSignal("confirmed");

    public static IObservable<string> OnCustomAction(this Godot.AcceptDialog obj) =>
      obj.ObserveSignal<string>("custom_action");

    public static IObservable<Unit> OnScrolling(this Godot.ScrollBar obj) => obj.ObserveSignal("scrolling");
    public static IObservable<Unit> OnAboutToShow(this Godot.MenuButton obj) => obj.ObserveSignal("about_to_show");
    public static IObservable<Unit> OnPopupHide(this Godot.Popup obj) => obj.ObserveSignal("popup_hide");
    public static IObservable<Unit> OnAboutToShow(this Godot.Popup obj) => obj.ObserveSignal("about_to_show");
    ...
    public static IObservable<int> OnTabSelected(this Godot.TabContainer obj) => obj.ObserveSignal<int>("tab_selected");
    public static IObservable<int> OnTabChanged(this Godot.TabContainer obj) => obj.ObserveSignal<int>("tab_changed");
    public static IObservable<Unit> OnSortChildren(this Godot.Container obj) => obj.ObserveSignal("sort_children");
    public static IObservable<int> OnTabClose(this Godot.TabContainer obj) => obj.ObserveSignal<int>("tab_close");
    public static IObservable<int> OnTabClicked(this Godot.TabContainer obj) => obj.ObserveSignal<int>("tab_clicked");

    public static IObservable<int> OnRepositionActiveTabRequest(this Godot.TabContainer obj) =>
      obj.ObserveSignal<int>("reposition_active_tab_request");

    public static IObservable<int> OnRightButtonPressed(this Godot.TabContainer obj) =>
      obj.ObserveSignal<int>("right_button_pressed");

    public static IObservable<int> OnTabHover(this Godot.TabContainer obj) => obj.ObserveSignal<int>("tab_hover");
    public static IObservable<Unit> OnPrePopupPressed(this Godot.TabBar obj) => obj.ObserveSignal("pre_popup_pressed");
    public static IObservable<int> OnTabSelected(this Godot.TabBar obj) => obj.ObserveSignal<int>("tab_selected");
    public static IObservable<int> OnTabChanged(this Godot.TabBar obj) => obj.ObserveSignal<int>("tab_changed");
    public static IObservable<int> OnTabClose(this Godot.TabBar obj) => obj.ObserveSignal<int>("tab_close");
    public static IObservable<int> OnTabClicked(this Godot.TabBar obj) => obj.ObserveSignal<int>("tab_clicked");
    ...
    public static IObservable<int> OnTabHover(this Godot.TabBar obj) => obj.ObserveSignal<int>("tab_hover");

    public static IObservable<Unit> OnScrollStarted(this Godot.ScrollContainer obj) =>
      obj.ObserveSignal("scroll_started");

    public static IObservable<Unit> OnScrollEnded(this Godot.ScrollContainer obj) => obj.ObserveSignal("scroll_ended");
    public static IObservable<int> OnItemActivated(this Godot.ItemList obj) => obj.ObserveSignal<int>("item_activated");
    ...
    public static IObservable<Unit> OnNothingSelected(this Godot.ItemList obj) => obj.ObserveSignal("nothing_selected");
    ...
    public static IObservable<int> OnItemSelected(this Godot.ItemList obj) => obj.ObserveSignal<int>("item_selected");
    ...
    public static IObservable<Unit> OnFinished(this Godot.VideoStreamPlayer obj) => obj.ObserveSignal("finished");
    public static IObservable<int> OnIndexPressed(this Godot.PopupMenu obj) => obj.ObserveSignal<int>("index_pressed");
    public static IObservable<int> OnIdFocused(this Godot.PopupMenu obj) => obj.ObserveSignal<int>("id_focused");
    public static IObservable<int> OnIdPressed(this Godot.PopupMenu obj) => obj.ObserveSignal<int>("id_pressed");
    public static IObservable<Unit> OnItemActivated(this Godot.Tree obj) => obj.ObserveSignal("item_activated");
    ...
    public static IObservable<Unit> OnItemRmbEdited(this Godot.Tree obj) => obj.ObserveSignal("item_rmb_edited");
    public static IObservable<Unit> OnItemEdited(this Godot.Tree obj) => obj.ObserveSignal("item_edited");
    ...
    public static IObservable<Unit> OnNothingSelected(this Godot.Tree obj) => obj.ObserveSignal("nothing_selected");

    public static IObservable<Unit> OnItemDoubleClicked(this Godot.Tree obj) =>
      obj.ObserveSignal("item_double_clicked");

    public static IObservable<Vector2> OnEmptyRmb(this Godot.Tree obj) => obj.ObserveSignal<Vector2>("empty_rmb");

    public static IObservable<Vector2> OnItemRmbSelected(this Godot.Tree obj) =>
      obj.ObserveSignal<Vector2>("item_rmb_selected");

    public static IObservable<Unit> OnItemSelected(this Godot.Tree obj) => obj.ObserveSignal("item_selected");
    public static IObservable<Unit> OnCellSelected(this Godot.Tree obj) => obj.ObserveSignal("cell_selected");
    ...
    public static IObservable<Unit> OnTextChanged(this Godot.TextEdit obj) => obj.ObserveSignal("text_changed");
    ...
    public static IObservable<Unit> OnCursorChanged(this Godot.TextEdit obj) => obj.ObserveSignal("cursor_changed");
    ...
    public static IObservable<int> OnItemFocused(this Godot.OptionButton obj) => obj.ObserveSignal<int>("item_focused");
    ...
    public static IObservable<int> OnDragged(this Godot.SplitContainer obj) => obj.ObserveSignal<int>("dragged");
    public static IObservable<Unit> OnRaiseRequest(this Godot.GraphNode obj) => obj.ObserveSignal("raise_request");
    public static IObservable<Unit> OnCloseRequest(this Godot.GraphNode obj) => obj.ObserveSignal("close_request");
    ...
    public static IObservable<Unit> OnOffsetChanged(this Godot.GraphNode obj) => obj.ObserveSignal("offset_changed");
    ...
    public static IObservable<Unit> OnBeginNodeMove(this Godot.GraphEdit obj) => obj.ObserveSignal("_begin_node_move");

    public static IObservable<(string From, int FromSlot, Vector2 ReleasePosition)>
      OnConnectionToEmpty(this Godot.GraphEdit obj) => obj.ObserveSignal<string, int, Vector2>("connection_to_empty");

    public static IObservable<(string From, int FromSlot, string To, int ToSlot)>
      OnDisconnectionRequest(this Godot.GraphEdit obj) =>
      obj.ObserveSignal<string, int, string, int>("disconnection_request");

    public static IObservable<(string From, int FromSlot, string To, int ToSlot)>
      OnConnectionRequest(this Godot.GraphEdit obj) =>
      obj.ObserveSignal<string, int, string, int>("connection_request");

    public static IObservable<Unit> OnEndNodeMove(this Godot.GraphEdit obj) => obj.ObserveSignal("_end_node_move");

    public static IObservable<(string To, int ToSlot, Vector2 ReleasePosition)>
      OnConnectionFromEmpty(this Godot.GraphEdit obj) =>
    ...
    public static IObservable<(GodotObject Object, NodePath Key, float Elapsed, GodotObject Value)>
      OnTweenStep(this Godot.Tween obj) => obj.ObserveSignal<GodotObject, NodePath, float, GodotObject>("tween_step");

    public static IObservable<Unit> OnTweenAllCompleted(this Godot.Tween obj) =>
      obj.ObserveSignal("tween_all_completed");

    public static IObservable<(GodotObject Object, NodePath Key)> OnTweenCompleted(this Godot.Tween obj) =>
      obj.ObserveSignal<GodotObject, NodePath>("tween_completed");

    public static IObservable<(GodotObject Object, NodePath Key)> OnTweenStarted(this Godot.Tween obj) =>
      obj.ObserveSignal<GodotObject, NodePath>("tween_started");

    public static IObservable<Unit> OnRemovedFromGraph(this Godot.AnimationNode obj) =>
      obj.ObserveSignal("removed_from_graph");

    public static IObservable<Unit> OnTreeChanged(this Godot.AnimationNode obj) => obj.ObserveSignal("tree_changed");
    ...
    public static IObservable<Unit> OnFrameChanged(this Godot.Sprite3D obj) => obj.ObserveSignal("frame_changed");

    public static IObservable<Unit> OnFrameChanged(this Godot.AnimatedSprite3D obj) =>
      obj.ObserveSignal("frame_changed");

    public static IObservable<Unit> OnRangeChanged(this Godot.Curve obj) => obj.ObserveSignal("range_changed");
    ...
    public static
      IObservable<(Godot.Node Camera, Godot.InputEvent Event, Vector3 ClickPosition, Vector3 ClickNormal, int ShapeIdx)>
      OnInputEvent(this Godot.CollisionObject3D obj) =>
    ...
    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int LocalShape)>
      OnBodyShapeEntered(this Godot.RigidBody3D obj) =>
    ...
    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int LocalShape)>
      OnBodyShapeExited(this Godot.RigidBody3D obj) =>
    ...
    public static IObservable<(int AreaId, Godot.Area3D Area, int AreaShape, int SelfShape)>
      OnAreaShapeExited(this Godot.Area3D obj) => obj.ObserveSignal<int, Godot.Area3D, int, int>("area_shape_exited");

    public static IObservable<Godot.Node> OnBodyEntered(this Godot.Area3D obj) =>
      obj.ObserveSignal<Godot.Node>("body_entered");

    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int AreaShape)>
      OnBodyShapeEntered(this Godot.Area3D obj) => obj.ObserveSignal<int, Godot.Node, int, int>("body_shape_entered");

    public static IObservable<Godot.Area3D> OnAreaEntered(this Godot.Area3D obj) =>
      obj.ObserveSignal<Godot.Area3D>("area_entered");

    public static IObservable<(int AreaId, Godot.Area3D Area, int AreaShape, int SelfShape)>
      OnAreaShapeEntered(this Godot.Area3D obj) => obj.ObserveSignal<int, Godot.Area3D, int, int>("area_shape_entered");

    public static IObservable<Godot.Node> OnBodyExited(this Godot.Area3D obj) =>
      obj.ObserveSignal<Godot.Node>("body_exited");

    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int AreaShape)>
      OnBodyShapeExited(this Godot.Area2D obj) => obj.ObserveSignal<int, Godot.Node, int, int>("body_shape_exited");

    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int AreaShape)>
      OnBodyShapeExited(this Godot.Area3D obj) => obj.ObserveSignal<int, Godot.Node, int, int>("body_shape_exited");

    public static IObservable<(string GroupName, Godot.Collections.Array Parameters)>
      OnBroadcast(this Godot.VisibleOnScreenNotifier3D obj) =>
      obj.ObserveSignal<string, Godot.Collections.Array>("broadcast");

    public static IObservable<Unit> OnCurveChanged(this Godot.Path2D obj) => obj.ObserveSignal("curve_changed");
    public static IObservable<Unit> OnCurveChanged(this Godot.Path3D obj) => obj.ObserveSignal("curve_changed");

    public static IObservable<Godot.Camera2D> OnCameraExited(this Godot.VisibleOnScreenNotifier2D obj) =>
      obj.ObserveSignal<Godot.Camera2D>("camera_exited");

    public static IObservable<Unit> OnScreenEntered(this Godot.VisibleOnScreenNotifier2D obj) =>
      obj.ObserveSignal("screen_entered");

    public static IObservable<Godot.Camera2D> OnCameraEntered(this Godot.VisibleOnScreenNotifier2D obj) =>
      obj.ObserveSignal<Godot.Camera2D>("camera_entered");
    ...
    public static IObservable<Unit> OnFrameChanged(this Godot.Sprite2D obj) => obj.ObserveSignal("frame_changed");
    public static IObservable<Unit> OnTextureChanged(this Godot.Sprite2D obj) => obj.ObserveSignal("texture_changed");
    ...
    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int LocalShape)>
      OnBodyShapeEntered(this Godot.RigidBody2D obj) =>
      obj.ObserveSignal<int, Godot.Node, int, int>("body_shape_entered");
    ...
    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int LocalShape)>
      OnBodyShapeExited(this Godot.RigidBody2D obj) =>
      obj.ObserveSignal<int, Godot.Node, int, int>("body_shape_exited");
    ...
    public static IObservable<(Godot.Node Viewport, Godot.InputEvent Event, int ShapeIdx)>
      OnInputEvent(this Godot.CollisionObject2D obj) =>
    ...
    public static IObservable<(int AreaId, Godot.Area2D Area, int AreaShape, int SelfShape)>
      OnAreaShapeExited(this Godot.Area2D obj) => obj.ObserveSignal<int, Godot.Area2D, int, int>("area_shape_exited");

    public static IObservable<Godot.Node> OnBodyEntered(this Godot.Area2D obj) =>
      obj.ObserveSignal<Godot.Node>("body_entered");

    public static IObservable<(int BodyId, Godot.Node Body, int BodyShape, int AreaShape)>
      OnBodyShapeEntered(this Godot.Area2D obj) => obj.ObserveSignal<int, Godot.Node, int, int>("body_shape_entered");

    public static IObservable<Godot.Area2D> OnAreaEntered(this Godot.Area2D obj) =>
      obj.ObserveSignal<Godot.Area2D>("area_entered");

    public static IObservable<(int AreaId, Godot.Area2D Area, int AreaShape, int SelfShape)>
      OnAreaShapeEntered(this Godot.Area2D obj) => obj.ObserveSignal<int, Godot.Area2D, int, int>("area_shape_entered");

    public static IObservable<Godot.Node> OnBodyExited(this Godot.Area2D obj) =>
      obj.ObserveSignal<Godot.Node>("body_exited");

    public static IObservable<Godot.Viewport> OnViewportEntered(this Godot.VisibleOnScreenNotifier2D obj) =>
      obj.ObserveSignal<Godot.Viewport>("viewport_entered");

    public static IObservable<Godot.Viewport> OnViewportExited(this Godot.VisibleOnScreenNotifier2D obj) =>
    ...
    public static IObservable<Unit> OnSettingsChanged(this Godot.TileMap obj) => obj.ObserveSignal("settings_changed");
    public static IObservable<Unit> OnReleased(this Godot.TouchScreenButton obj) => obj.ObserveSignal("released");
    public static IObservable<Unit> OnPressed(this Godot.TouchScreenButton obj) => obj.ObserveSignal("pressed");
    public static IObservable<Unit> OnTracksChanged(this Godot.Animation obj) => obj.ObserveSignal("tracks_changed");

    public static IObservable<Unit> OnTextureChanged(this Godot.StyleBoxTexture obj) =>
      obj.ObserveSignal("texture_changed");

    public static IObservable<Unit> OnFinished(this Godot.AudioStreamPlayer obj) => obj.ObserveSignal("finished");
    public static IObservable<Unit> OnFinished(this Godot.AudioStreamPlayer2D obj) => obj.ObserveSignal("finished");
    public static IObservable<Unit> OnFinished(this Godot.AudioStreamPlayer3D obj) => obj.ObserveSignal("finished");
    ...
    public static IObservable<Unit> OnPhysicsFrame(this Godot.SceneTree obj) => obj.ObserveSignal("physics_frame");
    public static IObservable<Unit> OnScreenResized(this Godot.SceneTree obj) => obj.ObserveSignal("screen_resized");
    ...
    public static IObservable<Unit> OnIdleFrame(this Godot.SceneTree obj) => obj.ObserveSignal("idle_frame");
    ...
    public static IObservable<Unit> OnTreeChanged(this Godot.SceneTree obj) => obj.ObserveSignal("tree_changed");
    ...
    public static IObservable<Unit> OnTimeout(this Godot.SceneTreeTimer obj) => obj.ObserveSignal("timeout");
    ...
    public static IObservable<(GodotObject Res, string Prop)> OnResourceSelected(this Godot.EditorInspector obj) =>
      obj.ObserveSignal<GodotObject, string>("resource_selected");
    ...
    public static IObservable<(string Property, object Value)>
      OnPropertyKeyedWithValue(this Godot.EditorProperty obj) =>
    ...
    public static IObservable<(string Path, Godot.Resource Resource)>
      OnResourceSelected(this Godot.EditorProperty obj) =>
    ...
    public static IObservable<(string[] Properties, Godot.Collections.Array Value)>
      OnMultiplePropertiesChanged(this Godot.EditorProperty obj) =>
    ...
    public static IObservable<string> OnInherit(this Godot.FileSystemDock obj) => obj.ObserveSignal<string>("inherit");
    ...
    public static IObservable<(string Media, int Index, string Name)>
      OnIceCandidateCreated(this Godot.WebRtcPeerConnection obj) =>
      obj.ObserveSignal<string, int, string>("ice_candidate_created");

    public static IObservable<(string Type, string Sdp)>
      OnSessionDescriptionCreated(this Godot.WebRtcPeerConnection obj) =>
      obj.ObserveSignal<string, string>("session_description_created");

    public static IObservable<GodotObject> OnDataChannelReceived(this Godot.WebRtcPeerConnection obj) =>
      obj.ObserveSignal<GodotObject>("data_channel_received");
    ...
    public static IObservable<Unit> OnDataReceived(this Godot.WebSocketPeer obj) => obj.ObserveSignal("data_received");
  ...
  public static class VisualServerSignals {
    public static IObservable<Unit> OnFramePostDraw() => Observable.FromEvent(
      h => RenderingServer.Singleton.FramePostDraw += h,
      h => RenderingServer.Singleton.FramePostDraw -= h
    );

    public static IObservable<Unit> OnFramePreDraw() => Observable.FromEvent(
      h => RenderingServer.Singleton.FramePreDraw += h,
      h => RenderingServer.Singleton.FramePreDraw -= h
    );
  ...
  public static class InputSignals {
    public static IObservable<(long Device, bool Connected)> OnJoyConnectionChanged() => Observable
      .FromEvent<InputInstance.JoyConnectionChangedEventHandler, (long id, bool connected)>(
        h => Input.Singleton.JoyConnectionChanged += h,
        h => Input.Singleton.JoyConnectionChanged -= h);
  }

  public static class AudioServerSignals {
    public static IObservable<Unit> OnBusLayoutChanged() => Observable.FromEvent(
      h => AudioServer.Singleton.BusLayoutChanged += h,
      h => AudioServer.Singleton.BusLayoutChanged -= h
    );
  }

  public static class XRServerSignals {
    public static IObservable<(string TrackerName, int Type, int Id)> OnTrackerRemoved() => Observable
      .FromEvent<XRServerInstance.TrackerRemovedEventHandler, (string trackerName, int type, int id)>(
        h => XRServer.Singleton.TrackerRemoved += h,
        h => XRServer.Singleton.TrackerRemoved -= h);

    public static IObservable<(string TrackerName, int Type, int Id)> OnTrackerAdded() => Observable
      .FromEvent<XRServerInstance.TrackerAddedEventHandler, (string trackerName, int type, int id)>(
        h => XRServer.Singleton.TrackerAdded += h,
        h => XRServer.Singleton.TrackerAdded -= h);

    public static IObservable<string> OnInterfaceRemoved() =>
      Observable.FromEvent<XRServerInstance.InterfaceRemovedEventHandler, string>(
        h => XRServer.Singleton.InterfaceRemoved += h, h => XRServer.Singleton.InterfaceRemoved -= h);

    public static IObservable<string> OnInterfaceAdded() =>
      Observable.FromEvent<XRServerInstance.InterfaceAddedEventHandler, string>(
        h => XRServer.Singleton.InterfaceAdded += h, h => XRServer.Singleton.InterfaceAdded -= h);
  }

  public static class CameraServerSignals {
    public static IObservable<int> OnCameraFeedRemoved() =>
      Observable.FromEvent<CameraServerInstance.CameraFeedRemovedEventHandler, int>(
        h => CameraServer.Singleton.CameraFeedRemoved += h, h => CameraServer.Singleton.CameraFeedRemoved -= h);

    public static IObservable<int> OnCameraFeedAdded() =>
      Observable.FromEvent<CameraServerInstance.CameraFeedAddedEventHandler, int>(
        h => CameraServer.Singleton.CameraFeedAdded += h, h => CameraServer.Singleton.CameraFeedAdded -= h);
  }
}
